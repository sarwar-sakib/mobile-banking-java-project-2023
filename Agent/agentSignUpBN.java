...
//                setVisible(false);
        ...
        signUpButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                Agent user = new Agent (label1Text.getText(), label2Text.getText(), label3Text.getText(), gender, Date, Month, Year, label6Text.getText(), new String(label7Pass.getPassword()), label8Text.getText());
