        ...
        nextButton2.addActionListener(new ActionListener () {
            public void actionPerformed (ActionEvent e) {
                if (password.equals(new String(addMonPass.getPassword()))) {
                    ...
                    String query3 = "INSERT INTO " + mobile + "trans(INGOING, DATE, AMOUNT) VALUES ('IN', '" + getDateTime() + "','"+ Double.parseDouble(amountText.getText()) + "')";
...
//                setVisible(false);
        ...
        backButton.addAction Listener(new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                HomePage home = new HomePage(mobile);
                home.setVisible(true);
                dispose();
